...
const unifiedApi = {
  ...
  // 🗓️ Meetings / Demos
  // --- START OF CHANGE: Updated meeting and demo scheduling payloads ---
  ...
  scheduleDemo: (payload: {
    ...
    fetcher("Demos/Create", { method: "POST", body: JSON.stringify(mapKeysToPascalCase({ ...payload, event_time: payload.start_time })) }),
  // --- END OF CHANGE ---
