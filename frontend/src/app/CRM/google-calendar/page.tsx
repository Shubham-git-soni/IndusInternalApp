    ...
    return (
        <TooltipProvider>
            <div className="py-3 lg:py-4 space-y-3 lg:space-y-4">
                <div>
                    <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">Team Calendar</h1>
                    <p className="text-sm sm:text-base text-muted-foreground">View all scheduled meetings and demos for your team.</p>
                </div>
                            ...
                            <details className="text-sm border rounded-lg p-3 md:max-w-md">
                                ...
                                <div className="mt-3 space-y-3">
                                    <AlertDescription className="text-muted-foreground">
                                        ...
                                        <br/><br/>
                                        <div className="p-2 bg-muted border-l-4 border-border">
                                            <p className="font-bold text-foreground">Important Note on Sync Speed:</p>
                                            <p className="text-foreground">Google Calendar controls how often it checks for updates. While new events will sync automatically, it may take <span className="font-semibold">several hours</span> for changes to appear. This delay is controlled by Google, not the CRM.</p>
                                        </div>
                                        <br/>
