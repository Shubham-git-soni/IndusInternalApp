                  ...
                  <div className="grid gap-0 grid-cols-1 md:grid-cols-5 items-end">
                    ...
                    <div className="space-y-4 md:col-span-2">
                      ...
                      <Input
                        ...
                        className={`w-full md:w-10/12 ${errors.contacts?.[index]?.first_name ? "border-destructive" : ""}`}
                      />
                    </div>
                    <div className="space-y-1 md:col-span-2">
                      ...
                      <Input
                        ...
                        className={errors.contacts?.[index]?.last_name ? "border-destructive" : ""}
                      />
                    </div>
                  </div>
                  <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                    <div className="space-y-1">
                      ...
                      <PhoneInput
                        ...
                        inputClass={`!w-full !flex !h-10 !rounded-md !border !bg-background !pl-10 !px-3 !py-2 !text-sm ${errors.contacts?.[index]?.phone ? "!border-destructive" : "!border-input"}`}
                      />
                    </div>
            ...
            <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              ...
              <div className="space-y-1">
                ...
                <Select value={formData.assigned_to} onValueChange={value => handleInputChange("assigned_to", value)}>
                  <SelectTrigger id="assigned_to" className={errors.assigned_to ? "border-destructive" : ""}>
