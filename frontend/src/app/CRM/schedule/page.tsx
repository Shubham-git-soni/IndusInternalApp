...
export default function SchedulePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const selectedLead = allLeads.find(l => l.id.toString() === formData.lead_id);
                ...
                <CardContent className="px-3 sm:px-6">
                  <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-6">
                    ...
                    <div className="grid gap-3 grid-cols-2">
                     ...
                     {/* --- START OF CHANGE: Attendee Multi-Select --- */}
                    <div className="space-y-1">
                        ...
                        <PopoverContent className="w-[--radix-popover-trigger-width] p-0">
                          <Command>
                            ...
                            <CommandGroup>
                                <ScrollArea className="h-[200px]">
                                {users
                                    .filter(u => u.username !== formData.assigned_to) // Exclude the main assignee
                                    .map((user) => (
                                    <CommandItem
                                        key={user.id}
                                        value={user.username}
                    ...
                    {/* --- END OF CHANGE: Attendee Multi-Select --- */}
