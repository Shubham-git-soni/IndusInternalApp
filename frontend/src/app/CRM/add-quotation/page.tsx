...
// --- START OF FIX: Import ApiLeadSearchResult and ScrollArea ---
...
export default function AddQuotationPage() {
  // --- START OF FIX: Update state to handle optimized search ---
  ...
  // --- START OF FIX: This useEffect is no longer needed as we fetch on demand ---
  // useEffect(() => { ... }, [])
  // --- END OF FIX ---
  ...
  // --- START OF FIX: Implement on-demand fetching and client-side filtering ---
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              {/* --- START OF FIX: Updated Select component with search and scroll --- */}
